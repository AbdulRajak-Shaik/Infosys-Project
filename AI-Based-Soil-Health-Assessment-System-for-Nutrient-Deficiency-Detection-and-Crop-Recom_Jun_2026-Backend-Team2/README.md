...
Set these values in `.env` before using **Forgot password**. For Gmail, enable
two-step verification and use an app password:
...
The reset flow sends a six-digit code that expires after 10 minutes.
